  ...
  return (
    <section className="w-full">
      <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-72 lg:w-96 flex-shrink-0 py-10 md:fixed md:top-0 md:left-1/2 md:transform md:-translate-x-1/2 md:h-screen md:flex md:flex-col md:items-end">
          <div className="px-6 md:px-0 md:pr-10 md:mr-auto">
            <h1 
